...
RabbitMQ's management page is at [http://localhost:15672](http://localhost:15672).
...
[https://archive.org/details/stackexchange](https://archive.org/details/stackexchange). Download: [http://www.brentozar.com/go/querystack](http://www.brentozar.com/go/querystack)
...
ALTER DATABASE StackOverflow2013
  MODIFY FILE (NAME = 'StackOverflow2013_log', SIZE = 4GB, FILEGROWTH = 512MB);
```
